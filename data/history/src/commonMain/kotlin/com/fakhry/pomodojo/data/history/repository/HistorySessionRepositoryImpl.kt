package com.fakhry.pomodojo.data.history.repository
...
import com.fakhry.pomodojo.data.history.mapper.mapToDomain
import com.fakhry.pomodojo.data.history.mapper.toHistoryEntity
...
class HistorySessionRepositoryImpl(
    ...
    private val timeZoneUtc = TimeZone.Companion.UTC
    private val userTimeZone = TimeZone.Companion.currentSystemDefault()
    ...
    private fun dayBounds(epochMs: Long): Pair<Long, Long> {
        val sessionDate =
            Instant.Companion.fromEpochMilliseconds(epochMs).toLocalDateTime(userTimeZone).date
